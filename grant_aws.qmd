...
- Giving us buffer we (Robin?) want to submit May 30

- MDA proposition should be done May 28

- Write the grant with feedback from AWS 

- Write high level summary and get feedback from AWS Team May 20
...
At CORI we are helpintg rural communities and their leaders understand the rural divide and reduce it. Our broadband team contribute to the second part and our research team provide inside on the second part. 

Both rely on frech, actionable and easy to share data. To do that our mapping and data team have been ingested, processed FCC data and are shared those results either with web apps or with in-house analytics. Sadly our manual processes do not allow us
- to keep up with the volume and frequencies of FCC releases
- get the granularity that expert on the ground needs 
- keep memory over time to drive thought leadership

Both Momentum to Modernize and Go Further, Faster could potentially help us and provide new opportunity to become a hub and source of truth/expertise on broadband data.
