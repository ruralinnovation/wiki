...
To do this we need:
  ...
  - Understanding of telecommunications **infrastructure** and landscape:
      ...
      - **Social/Demographic** quality of (potential) subscribers
      - **Physical Layout** of existing network and potential (future) networks
          - Calculate route miles needed for potential deployments in more sophisticated manner
  - Understanding real life performance of broadband networks
